        ...
        <div class="col-md-8">
            <div class="card">
                <div class="card-header">
                    <h3 class="card-title">Editar Autor: {{ $autor->nome }}</h3>
                </div>
                <form action="{{ route('autores.update', $autor->codAu) }}" method="POST">
                    ...
                    <div class="card-body">
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control @error('nome') is-invalid @enderror"
                                   id="nome" name="nome" value="{{ old('nome', $autor->nome) }}"
                    ...
                    <div class="card-footer">
                        ...
                        <a href="{{ route('autores.index') }}" class="btn btn-default">
                ...
                <div class="card-body">
                    <div class="list-group list-group-flush">
                        <div class="list-group-item d-flex justify-content-between align-items-center">
                            ...
                            <span class="badge badge-primary">{{ $autor->codAu }}</span>
                        </div>
                        <div class="list-group-item d-flex justify-content-between align-items-center">
                            <strong>Total de Livros:</strong>
                            <span class="badge badge-success">{{ $autor->livros_count }} livro(s)</span>
                        </div>
                        <div class="list-group-item">
                            <strong>Data de Cadastro:</strong><br>
                            <small class="text-muted">{{ $autor->created_at->format('d/m/Y H:i') }}</small>
                        </div>
                        <div class="list-group-item">
                            <strong>Última Atualização:</strong><br>
                            <small class="text-muted">{{ $autor->updated_at->format('d/m/Y H:i') }}</small>
                        </div>
                    </div>
                </div>
            </div>
